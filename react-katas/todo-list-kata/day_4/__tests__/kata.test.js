...
describe('todo list', () => {
    ...
    test('canceled task has disabled cancel and complete buttons', () => {
        ...
        const canceledTask = taskList.find('.canceled');
        const cancelButton = canceledTask.find('.cancel');
        const completeButton = canceledTask.find('.complete');
    ...
    test('completed task has disabled cancel and complete buttons', () => {
        ...
        const canceledTask = taskList.find('.completed');
        const cancelButton = canceledTask.find('.cancel');
        const completeButton = canceledTask.find('.complete');
